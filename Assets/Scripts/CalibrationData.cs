...
public class CalibrationData
{
    ...
    public void Tick(Quaternion newTarget, float speed)
    {
        ...
        if(IsQuaternionValid(targetRotation))
        {
    ...
    { 
        // Quaternion referenceQ = new Quaternion(0f, 0f, 0f, 1f);
        Quaternion referenceQ = new Quaternion(0f, 0f, 0f, 0f);
        bool check = !Quaternion.Equals(q, referenceQ);
        return check; 
    } 
